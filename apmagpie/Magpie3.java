...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		|| findKeyword(statement, "HI")) >= 0{
		    response = "Hello computer human user! How are you doing today!";
		}
		else if (findKeyword(statement, "Great!")
		||findKeyword(statement, "great")){
		    response = ("That is awesome to hear!");
		}
		else
		{
